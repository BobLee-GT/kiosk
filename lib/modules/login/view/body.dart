...
extension BodyCustom on LoginScreen {
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                _btnVerifyWithBHYT(),
                spaceVertical(height: 48),
                _moreInfo(svgImage: AssetSVGName.time, title: 'Tiết kiệm thời gian'),
                spaceVertical(height: 20),
  ...
  Widget _btnVerifyWithCCCD(){
    return CustomButton.commonButton(title: 'Xác thực Với Căn Cước Công Dân', onTap: controller.onTapCCCD, colorFilter:ColorFilter.mode(AppColor.colorUnknown3, BlendMode.color));
  }
